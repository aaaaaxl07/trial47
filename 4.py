...
class create:
    ...
    def start(self):
        ...
        headers = {
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; HMA-L29; HMSCore 6.12.0.302; GMSCore 20.30.19) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.88 HuaweiBrowser/14.0.0.365 Mobile Safari/537.36',
            'viewport-width': '980',
        }
        headers1 = {
            'authority': 'm.facebook.com',
