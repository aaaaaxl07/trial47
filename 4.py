...
\x1b[1;91m-----------------------------------------------
\x1b[1;97m> Author :  prekarsha hutto
\x1b[1;97m> Github : https://github.com/SHOOTER-MAKER
\x1b[1;97m> Facebok: Jutt Badshah
\x1b[1;97m> Version: any 3 min after airplane mod on/off 
\x1b[0;97m-----------------------------------------------"""
boy = ['Ali Khan', 'Rustam Khan', 'Faisal Khan', 'Afzal Khan', 'Haider Khan', 'Suleman Khan', 'Nadeem Khan', 'Nazeer Malik', 'Nazeer Jutt', 'Nazeer Rehmani', 'Safdar Malik', 'Intzar Khan', 'Saleem Malik', 'Abdullah Malik', 'Naseer Jutt', 'Muzammil Malik', 'Fiaz Ahmad', 'Asghar Ali', 'Shabeer Ahmad', 'Irfan Ali', 'Ahmad Gujjar', 'prekash khan', 'sadun khan', 'isuru kahan', 'jag ruwn', 'appo lhan', 'penda hutto', 'pre isur', 'janaki yako', 'oskage ahasa', 'kumuthu idu', 'achintha kau', 'palat yak', 'lomema mage', 'ranilge atta', 'bhandari yako', 'hum yako', 'Sajida Malik', 'Ayesha Khan', 'Nabeela Malik', 'Kinza Fatima', 'Arooj Khan', 'Muskan Khan', 'Ayesha Malik', 'Safina Malik', 'Nida Ali', 'Rimsha Ali']
